...
nnoremap <unique> N <cmd>call smoothie#do('N')<CR>
" nnoremap <unique> <C-i> <cmd>call smoothie#do("\<C-i>")<CR>
...
"Art words generated by https://texteditor.com/multiline-text-art/
let g:art_words = [
			\[
			\'▀████▀                              ▀███                ', 
			\'  ██                                  ██                ', 
...
let g:vimspector_termial_minwidth = 50
" let g:vimspector_session_windows.output = 0
...
" "   FloatermNew --height=15 --width=80 --name=VimspectorTerminal --position=right --wintype=normal --bufhidden=wipe
